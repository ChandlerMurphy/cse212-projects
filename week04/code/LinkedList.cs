...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // then we can call RemoveHead to remove that value
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If the location of 'value' is at the tail of the list,
                // then we can call RemoveTail to remove that value
                else if (curr == _tail)
                {
                    RemoveTail();
                }
                // For any other location of 'value', we need to remove the node 
                // and reconnect the links remaining.
                else
                {
                ...
                return; // We can exit the function after we remove the correct item
            }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            // If the location of the value matches the value we want to replace
            // then we will replace the old value with the new one.
